        ...
        <section className="projetos-portfolio" id='projetos'>
            ...
            <div className="container-sections projetos">
                ...
                <div className="card-container">
                        <h2>Marmitaria</h2>
                        <a href="https://vitorrom.github.io/MarmitariaDada/" target="_blank" rel="noopener noreferrer">
                            <div className="card card-1">
                                <img src="assets\projeto-marmitaria.png" alt="Imagem do projeto" className="card-img" />
                            </div>
                        </a>
                        <div className="card-content">
                            <p>Um parente meu decidiu começar a vender marmitas, sendo assim, decidi demonstrar meu apoio criando um website para ajudar na praticidade de suas vendas, porém, está faltando criar o back-end do projeto...</p>
                        </div>
                ...
                <div className="container-sections projetos">
                    ...
                    <div class="card-container">
                        <h2>Website Engenharia</h2>
                        <a href="https://vitorrom.github.io/civil_engineering/" target="_blank" rel="noopener noreferrer">
                            <div class="card card-1">
                                <img src="assets\projeto-engenharia.png" alt='Imagem do projeto' className="card-img" />
                            </div>
                        </a>
